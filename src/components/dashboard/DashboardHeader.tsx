      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-800 dark:text-white font-semibold">MindTrack Balance</span>
          </div>

          {/* Navigation */}
          <nav className="hidden md:flex items-center gap-8 font-medium">
            <a href="/dashboard" className="text-purple-600 dark:text-purple-400">Dashboard</a>
            <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Insights</a>
            <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Community</a>
            <a href="/settings" className="text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Settings</a>
          </nav>
              ...
              <button className="flex items-center gap-2 hover:opacity-80 transition-opacity">
                <Avatar className="w-9 h-9">
                  <AvatarFallback className="bg-gradient-to-br from-purple-400 to-cyan-400 text-white font-bold uppercase">
                    {(user?.firstname || user?.login || "ME").slice(0, 2)}
                  </AvatarFallback>
                </Avatar>
              </button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-48 bg-white/95 dark:bg-slate-900/95 backdrop-blur-lg border-white/20 dark:border-white/10 dark:text-white">
              ...
              <SheetContent side="right" className="w-[300px] flex flex-col pt-0 px-0 bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl border-l border-gray-200 dark:border-slate-800">
                ...
                <div className="relative flex items-center justify-between h-16 border-b border-gray-100 dark:border-slate-800 mt-2">
                  <SheetHeader className="absolute left-6 top-1/2 -translate-y-1/2 space-y-0 text-left">
                    ...
                    <SheetDescription className="sr-only">Dashboard menu</SheetDescription>
                  </SheetHeader>
                </div>
                ...
                <nav className="flex flex-col gap-6 text-lg mt-8 px-8 pb-8 border-b border-gray-100 dark:border-slate-800">
                  <a href="/dashboard" className="text-purple-600 dark:text-purple-400 font-medium transition-colors">
                    Dashboard
                  </a>
                  <a href="#insights" className="text-gray-700 dark:text-gray-200 font-medium hover:text-purple-600 transition-colors">
                    Insights
                  </a>
                  <a href="#community" className="text-gray-700 dark:text-gray-200 font-medium hover:text-purple-600 transition-colors">
                    Community
                  </a>
                  <a href="/settings" className="text-gray-700 dark:text-gray-200 font-medium hover:text-purple-600 transition-colors">
                    Settings
                  </a>
                </nav>
